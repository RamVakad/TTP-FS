...
public class SwaggerConfig {
    ...
    private ApiInfo metadata() {
        return new ApiInfoBuilder()//
                ...
                .description("This is a the back-end service for the Fullstack Assessment application. It uses JWT for authentication & role management. Default Credentials: `user@email.com` or `admin@email.com`  (passwords are 'user' & 'admin') for testing purposes. Once you have successfully logged in and obtained the JWT, you should click on the right top button `Authorize` and introduce it with the prefix \"Bearer \".")
                .version("1.0.0")
